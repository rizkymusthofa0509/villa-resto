                ...
                <tbody>
                 <?php $no=1; foreach ($list->result() as $data): ?>
                  <tr>
                    ...
                    <td>
                      <label class="label label-success"><a href="<?= base_url() ?>apps/warning/master/jenis-delete/<?= $data->item_id ?>" title="Test"><i class="fa fa-pencil" style="color: white;"></i></a></label>
                      <label class="label label-warning"><a href="<?= base_url() ?>apps/warning/master/jenis-delete/<?= $data->item_id ?>" title="Test"><i class="fa fa-eye" style="color: white;"></i></a></label>
                      <label class="label label-danger"><a href="<?= base_url() ?>apps/warning/master/jenis-delete/<?= $data->item_id ?>" title="Test"><i class="fa fa-trash" style="color: white;"></i></a></label> 
                    </td>
                  </tr>  
              <?php endforeach ?>   
                </tbody>
