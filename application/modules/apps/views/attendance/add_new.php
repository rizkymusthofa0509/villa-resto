      ...
      <div class="col-md-12" style="margin-top: 20px;">
         <table border="1" width="100%" class="table table-bordered table-striped">
         	<tr>
         		...
         		<td valign="top">
         			<form action="<?= base_url() ?>apps/attendance/act/add-save" method="post">
         			<table class="table table-bordered table-striped">
         				...
         				<tr>
         					...
         					<td>
         						...
         						<input type="date" name="tanggal" value="<?= date_now() ?>" class="form-control">
         					</td>
         				</tr>
         				<tr>
         					<td class="bold" width="200px;">Jam Masuk</td>
         					<td>
         						<input type="time" value="<?= DATE("H:i"); ?>" name="time_in" class="form-control">
         					</td>
         				</tr>
         				<tr>
         					<td class="bold" width="200px;">Jam Pulang</td>
         					<td>
         						<input type="time" value="00:00" name="time_out" class="form-control">
         					</td>
         				</tr>
                        <tr>
                            <td class="bold" width="200px;">Catatan</td>
                            <td>
                                <input type="text" value="" name="catatan" class="form-control" placeholder="Working Hour.">
                            </td>
                        </tr>
         				<tr>
