 <form action="<?= base_url() ?>apps/attendance/settings/mesin-save" method="POST" >
   <div class="row"> 
           ...
           <table class="table table-bordered table-striped"> 
            <tr>
             ...
             <tr>
               ...
               <td>
                <div class="input-group input-group-sm">
                  <input type="text" class="form-control" name="ip_address" id="ip_address" value="192.168.5.221">
             ...
             <tr>
               ...
               <td>
                 <input type="text" name="comKey" id="comKey" class="form-control" value="83581" >
               </td> 
             </tr>
             <tr>
