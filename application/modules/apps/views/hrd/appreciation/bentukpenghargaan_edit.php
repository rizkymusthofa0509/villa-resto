 <div class="row"> 
  <div class="box box-danger box-solid ">
    ...
    <div class="box-body">
      <form action="<?= base_url() ?>apps/employee/appreciation/bentuk-penghargaan-update" method="POST">
         ...
         <table class="table table-bordered table-striped"> 
            ...
            <tr>
             ...
             <td>
               ...
               <input type="hidden" name="item_id" id="item_id" class="form-control" value="<?= $det['item_id'] ?>">
             </td> 
            </tr>
            <tr>
