...
<div class="row"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-bank"></i> Division</h3>
              <!-- Left -->
                ...
                <tbody>
                  <?php $no=1; foreach ($list->result() as $data): ?>
                    <tr>
                      ...
                      <td align="center">
                        <label class="label label-success"><a href="<?= base_url() ?>apps/hr/master/division-detail/<?= $data->division_id ?>" title="Test"><i class="fa fa-pencil" style="color: white;"></i></a></label>
                        <!-- <label class="label label-warning"><a href="<?= base_url() ?>apps/hr/master/division-detail/<?= $data->division_id ?>" title="Test"><i class="fa fa-eye" style="color: white;"></i></a></label> -->
                        <label class="label label-danger"><a href="<?= base_url() ?>apps/hr/master/division-detail/<?= $data->division_id ?>" title="Test"><i class="fa fa-trash" style="color: white;"></i></a></label> 
                      </td>
                    </tr>
                  <?php endforeach ?>    
                </tbody>
