      ...
      <div class="osahan-order">
         <div class="order-menu">
            ...
            <div class="row m-0 text-center">
               ...
               <div class="col pb-2 <?php if($this->input->get('status')=='diproses'){echo 'border-success';}  ?>  border-bottom">
                  <a href="<?= base_url() ?>apps/order?status=diproses" class="text-<?php if($this->input->get('status')=='diproses'){echo 'success';}else{echo 'muted';}  ?> text-decoration-none">On Progress</a>
               </div>
               <div class="col pb-2 <?php if($this->input->get('status')=='reject'){echo 'border-success';}  ?>  border-bottom">
                  <a href="<?= base_url() ?>apps/order?status=reject" class="text-<?php if($this->input->get('status')=='reject'){echo 'success';}else{echo 'muted';}  ?> text-decoration-none">Canceled</a>
               </div>
            </div>
         </div>
